...
#####################EXAMPLE VALIDATED PREFIX OUTPUT#################################
#Checking for BGP Update Header
#BGP Update Header Detected
#    Destination IP = 10.100.0.3
#    Source IP = 10.100.0.151
#    BGP Segment AS = 151
#    BGP Segment Next Hop = 10.100.0.151
#    BGP Segment NLRI = 10.151.0.0/24
#End of BGP Update Packet
#NLRI check: 10.151.0.0/24
#adv_segment=[151, '10.151.0.0', '24', 'Internal']
#validating advertisement for ASN: ACCOUNT151151
#Validating segment.....
#10.151.0.0
#24
#151
#Checking segment: AS151 , 10.151.0.0/24
#valid result =validatePrefixResult.prefixValid
#Segment Validated.

#####################EXAMPLE FAILED VALIDATION PREFIX OUTPUT#################################
#Packet inbound on interface: ix100
#Checking for BGP Update Header
#BGP Update Header Detected
#    Destination IP = 10.100.0.151
#    Source IP = 10.100.0.3
#    BGP Segment AS = 3
#    BGP Segment Next Hop = 10.100.0.3
#    BGP Segment NLRI = 10.3.0.0/24
#End of BGP Update Packet
#NLRI check: 10.3.0.0/24
#adv_segment=[3, '10.3.0.0', '24', 'Internal']
#validating advertisement for ASN: 3
#Validating segment.....
#10.3.0.0
#24
#3
#Checking segment: AS3 , 10.3.0.0/24
#valid result =validatePrefixResult.prefixNotRegistered
#Segment Validation Failed. Error: validatePrefixResult.prefixNotRegistered
#segment check = False
#AS 3 Failed Authorization, Sending Notification...
#.
#Sent 1 packets.
