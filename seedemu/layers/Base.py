...
class Base(Layer, Graphable):
    ...
    def createInternetExchange(self, asn: int, prefix: str = "auto", aac: AddressAssignmentConstraint = None, rsAddress = "auto") -> InternetExchange:
        """!
        ...
        self.__ixes[asn] = InternetExchange(asn, prefix, aac, rsAddress)
