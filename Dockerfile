...
RUN pip3 install py-solc-x web3 python-dotenv scapy==2.4.5 Pybird
# Use 4 byte ASNs
...
RUN echo "hDeddy"
RUN git clone --depth 1 --filter=blob:none -b ftr-path-validation https://github.com/KarlOlson/Seed_scalable_complete/
